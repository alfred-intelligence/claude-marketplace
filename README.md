...
/plugin install shywright@alfred
```
...
| `shywright` | Shy-first tool discipline + collections + orthogonality linting | [shywright-skill](https://github.com/alfred-intelligence/shywright-skill) |
